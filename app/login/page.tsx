    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-50 via-white to-emerald-50 p-4">
      <div className="card p-8 w-full max-w-md space-y-5">
        <div className="text-center">
          ...
          <div className="text-sm text-slate-500 mt-1">إدارة الشراكات المؤسسية وقياس الأثر</div>
        </div>
        ...
        <div className="text-xs text-slate-400 text-center pt-2 border-t">
          الحساب الافتراضي للتجربة: <code className="bg-slate-100 px-1 rounded">admin@local</code> / <code className="bg-slate-100 px-1 rounded">admin1234</code>
          <br />
          (يُغيَّر عبر <code>ADMIN_EMAIL</code> و <code>ADMIN_PASSWORD</code> في الإنتاج)
        </div>
      </div>
    </div>
  )
