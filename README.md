...
تطبيق ويب متكامل لإدارة الشراكات المؤسسية مبني على **منهجية GEOSA الرسمية** (أكتوبر 2025): دورة حياة من 4 مراحل (تقييم → تفعيل → متابعة → تحسين) للاتفاقيات الموقّعة، بالتوازي مع قمع استكشاف للمستهدفات المحتملة. واجهة عربية RTL بالكامل، مستقلة عن أي خدمة خارجية.

## المزايا

| المجال | المزايا |
|---|---|
| **منهجية GEOSA** | 4 مراحل دورة حياة + 4 تصنيفات (نوع الاتفاقية، تصنيف، صنف الجهة، مجال التعاون) |
| **لوحة معلومات** | مؤشرات GEOSA + 3 رسوم بيانية (تصنيف، صنف، مجالات تعاون) + خريطة جيومكانية |
| **إدارة الشراكات** | شراكات مبرمة (active) + مستهدفات (prospects) في عرض موحّد بتبويب |
| **اجتماعات المراجعة** | جدولة + تسجيل + تتبع رضا الطرفين + جدولة آلية للمراجعة بعد 6 أشهر |
| **الفرص الاستثمارية** | 6 مراحل بيع، CRUD كامل، حساب القيمة المرجّحة |
| **التواصل** | 6 قوالب رسائل عربية + جمهور مستهدف ديناميكي + تنزيل CSV + إرسال SMTP اختياري |
| **التقارير** | تقارير تنفيذية مؤتمتة + تصدير Excel + PDF |
| **التوصيات** | 10+ توصيات ذكية (5 GEOSA + 5 prospect-funnel) بأولويات |
